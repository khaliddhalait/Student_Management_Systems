								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body bg-card-color">
											<div class="card">
												<div class="card-body">
													<form id="coform" onsubmit="return validateCourse()" action="../CourseAddServlet" method="post">
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body bg-card-color">
											...
											<div class="card">
												<div class="card-body">
													<form id="subform" onsubmit="return validateSubject()" action="../AddSubjectServlet" method="post">
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body bg-card-color">
											<div class="card">
												<div class="card-body">
													<form id="atform" onsubmit="return validateTeacher()" action="../AddTeacherServlet" method="post">
														<div class="form-group">
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body bg-card-color">
											<div class="card">
												<div class="card-body">
													<form id="myform" onsubmit="return validateStudent()" action="../AddStudentServlet" method="post">
														<div class="form-group">
